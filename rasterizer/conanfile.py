...
class GPCFontRasterizerConan(ConanFile):
  ...
  requires = "freetype/2.6.3@lasote/stable", "Boost/1.60.0@lasote/stable", "libGPCFonts/0.1.1@JPGygax68/alpha", "cereal/0.1@JPGygax68/testing", "zlib/1.2.8@lasote/stable"
  generators = "cmake"
